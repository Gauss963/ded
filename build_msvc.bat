...
cl.exe %CFLAGS% %INCLUDES% /Feded src\main.c src\la.c src\editor.c src\file_browser.c src\free_glyph.c src\simple_renderer.c src\common.c src\lexer.c src\pdf_viewer.c /link %LIBS% -SUBSYSTEM:windows
